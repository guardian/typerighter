...
export function useRule(ruleId: number | undefined) {
  ...
  const fetchRule = async (ruleId: number) => {
    ...
    try {
      const response = await fetch(`${location}api/rules/${ruleId}`);
      if (!response.ok) {
  ...
  const publishRule = async (ruleId: number, reason: string) => {
    ...
    try {
      const response = await fetch(`${location}api/rules/${ruleId}/publish`, {
        method: "POST",
  ...
  const archiveRule = async (ruleId: number) => {
    ...
    try {
      const response = await fetch(`${location}api/rules/${ruleId}/archive`, {
        method: 'POST',
      });
  ...
  const unarchiveRule = async (ruleId: number) => {
    ...
    try {
      const response = await fetch(`${location}api/rules/${ruleId}/unarchive`, {
        method: 'POST',
      });
  ...
  const unpublishRule = async (ruleId: number) => {
    ...
    try {
      const response = await fetch(`${location}api/rules/${ruleId}/unpublish`, {
        method: 'POST',
      });
