...
class RuleManagerConfig(
  ...
  val connectionPoolInitialSize = playConfig.get[Int]("db.default.poolInitialSize")
  val connectionPoolMaxSize = playConfig.get[Int]("db.default.poolMaxSize")
  val connectionPoolTimeoutInMillis = playConfig.get[Int]("db.default.poolConnectionTimeoutMillis")
