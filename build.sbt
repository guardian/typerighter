...
val commonSettings = Seq(
  ...
  libraryDependencies ++= Seq(
    ...
    "ch.qos.logback" % "logback-classic" % "1.5.38", // manually overwriting logback-classic to resolve issue in Play framework: https://github.com/playframework/playframework/issues/11499
