...
riffRaffArtifactResources := Seq(
  ...
  baseDirectory.value / "checker/cfn/cfn.yaml" -> "cloudformation/checker.cfn.yaml",
  baseDirectory.value / "rule-manager/cfn/cfn.yaml" -> "cloudformation/rule-manager.cfn.yaml"
)