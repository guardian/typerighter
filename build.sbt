...
riffRaffArtifactResources := Seq(
  ...
  baseDirectory.value / "cdk/cfn/rule-manager.cfn.yaml" -> "cloudformation/rule-manager.cfn.yaml",
  baseDirectory.value / "cdk/cfn/rule-manager-db.cfn.yaml" -> "cloudformation/rule-manager-db.cfn.yaml"
)