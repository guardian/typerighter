...
class RegexMatcherTest extends AsyncFlatSpec with Matchers {
  ...
  "check" should "supercede matches generated by early rules if they overlap with matches generated by later rules" in {
    val overlapRules = createRules(List("to", "ton", "one", "got"))
    val overlapValidator = new RegexMatcher("example-category", overlapRules)
